    ...
    <div className="bg-app-surface border border-app-border rounded-2xl overflow-hidden flex flex-col h-auto sm:min-h-[150px] md:min-h-[170px]">
                  ...
                  <td className="px-4 py-3 flex items-center gap-2">
                    <button
                      onClick={(e) => {
                        e.preventDefault();
                        e.stopPropagation();
                        setDeleteTargetId(doc.document_id);
                      }}
                    >
                      <svg
                        width="16"
      ...
      {previewDoc && (
        <div className="fixed inset-0 z-50 flex items-center justify-center backdrop-blur-sm">
          <div className="bg-white p-6 rounded w-[90%] h-[90%] relative">
            <button
              className="absolute -top-4 -right-4 text-black bg-gray-100 hover:text-white hover:bg-red-500 rounded-full p-2"
