...
const RelationTable = ({
  ...
  const [visibilityTargetId, setVisibilityTargetId] = useState(null);
                  ...
                  <td className="px-4 py-3 flex items-center gap-2">
                    <button
                      onClick={(e) => {
                        e.preventDefault();
                        e.stopPropagation();
                        setVisibilityTargetId(service.id);
                      }}
                    >
                      <div
                        className={`text-xl ${
                          service.visibility ? "text-green-600" : "text-red-600"
                        }`}
                      >
                        {service.visibility ? <FaEye /> : <FaEyeSlash />}
                      </div>
                    </button>
                    {visibilityTargetId && (
                      <div className="fixed inset-0 backdrop-blur-sm flex justify-center items-center z-50">
                        <div className="bg-white p-6 rounded-3xl w-max max-w-4xl relative flex flex-col items-center border border-black">
                          ...
                          <p className="text-xl text-gray-700 pb-6 text-center px-10">
                          ...
                          <div className="flex gap-4 justify-center pt-4 w-full">
                            <button
                              ...
                              onClick={() => setVisibilityTargetId(null)}
                            >
                              Cancel
                            </button>
                            <button
